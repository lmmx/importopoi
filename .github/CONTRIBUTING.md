...
Firstly thank you for your interest in contributing to _importopoi_!
...
Next get the latest checkout of the _importopoi_ repository:

```sh
git clone git@github.com:lmmx/importopoi.git
```

Change into the newly created directory and **after activating your virtual environment**
install an editable version of importopoi along with its tests requirements:
...
Thank you for considering contribution to _importopoi_!
